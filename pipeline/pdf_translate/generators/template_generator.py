...
class TemplateGenerator:
    ...
    def _generate_preamble(
        ...
        parts.append("\\usepackage{calc}  % For \\minof and coordinate math")
        ...
        # Microtype for better typography and to prevent overflow
        parts.append("")
        parts.append("% ===== TYPOGRAPHY =====")
        parts.append("\\usepackage{microtype}")
        parts.append("\\emergencystretch=1.5em")
        parts.append("\\sloppy")
    ...
    def _generate_font_and_language_setup(self, target_language: str) -> str:
        """Generate font and language setup for polyglossia/fontspec compatibility."""
        lines = [r"\usepackage{fontspec}"]
        ...
        if target_language == "ru":
            ...
            lines.extend([
                r"\usepackage{polyglossia}",
                rf"\setmainlanguage{{{POLYGLOSSIA_LANGUAGES.get(target_language, 'english')}}}",
...
% Scientific papers often have very dense headers.
\titleformat{\section}{\large\bfseries}{}{0pt}{}
\titleformat{\subsection}{\normalsize\bfseries}{}{0pt}{}
\titleformat{\subsubsection}{\normalsize\itshape}{}{0pt}{}

% Tighten spacing around headings to match scientific paper density
% post-heading spacing kept small to maintain original breathing room
\titlespacing*{\section}{0pt}{10bp plus 2bp minus 2bp}{6bp plus 1bp}
\titlespacing*{\subsection}{0pt}{8bp plus 2bp minus 1bp}{4bp plus 1bp}
\titlespacing*{\subsubsection}{0pt}{6bp plus 1bp minus 1bp}{3bp plus 1bp}

% Precise paragraph skip
\setlength{\parskip}{3bp plus 1bp minus 0.5bp}
